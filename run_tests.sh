...
docker run -d -p 8545:8545 --name=${testrpc_name} trufflesuite/ganache-cli:latest  \
  ...
  --account="0x11111c8a390315310d8b616df1ec816f174526635ed440ca5c255b8a3ee1701d,10000000000000000000" \
  --account="0xfb8dd10f14b6a8ea9ac98261f28563c41708a14fc49820afb47d80fe8d6aba8c,76500000000000000000000" \
