module.exports = function () {
    this.When(/^Wallet dialogue with Name "([^"]*)" and Password "([^"]*)" and Password Confirmation "([^"]*)" are filled$/,
    ...
    this.Then(/^Logged out from wallet and Enter Password popup is displayed$/, async function () {
        return await page.dialogueEnterPassword.waitForPasswordPopup();
    });

    this.Then(/^Enter Password popup Password field validation error message is displayed$/, async function () {
    ...
    this.Then(/^Clear Create New Wallet Confirmation Password field$/, function () {
