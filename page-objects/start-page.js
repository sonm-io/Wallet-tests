module.exports = {
    ...
    waitForAccountsPage: async function () {
        return await shared.wdHelper.findVisibleElement(this.elements.accountsForm);
    },
    ...
    searchFromWalletDropdown: async function (searchValue) {
        return await page.common.enterValueForSearch(this.elements.dropdownSearchField, searchValue);
    },

    //get valets list from wallet dropdown

    getValuesFromWalletDropdown: async function () {
        return await page.common.getValuesFromDropdown(this.elements.dropdown, this.elements.dropdownValue);
    },
    ...
    verifyWalletIsNotPresent: async function (walletName) {
        let el = await driver.findElements(by.xpath('//li[.="' + walletName + '"]'));
    ...
    clearSearchWalletField: async function () {
        return await page.common.clearInputField(this.elements.dropdownSearchField);
    },
